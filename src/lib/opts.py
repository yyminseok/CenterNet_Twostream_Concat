...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument(
            '--data_type', default='llvip', help='kaist | llvip')
        ...
        self.parser.add_argument('--lr_step', type=str, default='90,120',  # 이부분 고치자
                                 help='drop learning rate by 10.')
        self.parser.add_argument('--num_epochs', type=int, default=10,  # 10으로 변경해야함
                                 help='total training epochs.')
        self.parser.add_argument('--batch_size', type=int, default=2,  # 5->12
                                 help='batch size')
        ...
        self.parser.add_argument('--keep_res', action='store_true',  # test때 resize여부  == (default=false,action='store_true')
    ...
    def parse(self, args=''):
        ...
        opt.data_dir = os.path.join(opt.root_dir, 'D:/data')
    ...
    def init(self, args=''):
        default_dataset_info = {
            'ctdet': {'default_resolution': [512, 512], 'num_classes': 1,  # 수정 80->1
